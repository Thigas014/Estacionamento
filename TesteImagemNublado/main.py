...
# Carrega a imagem
img = cv2.imread('if1TesteUmaVagaLivreNublado.jpeg')  # Altere para o caminho correto da sua imagem
...
cv2.waitKey(0)  # O loop agora é só até você pressionar uma tecla
